...
### HighLevel
- HTML - React
	 - Dialog https://souporserious.com/build-a-dialog-component-in-react/
	- StructuredClone - JSON.parse(JSON.stringify(obj))
	- array.at(-1)
	- import json
- Auth
	- jwt vs server-side session https://stackoverflow.com/questions/43452896/authentication-jwt-usage-vs-session
